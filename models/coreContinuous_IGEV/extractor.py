...
class Feature(SubModule):
    ...
    def forward(self, x):
        ...
        x8 = self.block2(x4)
        x16 = self.block3(x8)
        x32 = self.block4(x16)                      # [B,160,H/32,W/32]

        x16 = self.deconv32_16(x32, x16)            # [B,192,H/16,W/16]
        x8 = self.deconv16_8(x16, x8)               # [B,64,H/8,W/8]
        x4 = self.deconv8_4(x8, x4)                 
        x4 = self.conv4(x4)                         # [B,48,H/4,W/4]
        return [x4, x8, x16, x32]                   # [B,48,H/4,W/4] [B,64,H/8,W/8] [B,192,H/16,W/16] [B,160,H/32,W/32] 
